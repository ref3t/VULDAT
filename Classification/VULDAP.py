...
def checkCVEUsingAllTech():
    ...
    for mod in SentenceTransformersModels:
        ...
        for infoData in informationData:
            ...
            print(mod)
            dataframeResultsForallModels.to_excel(f"./results/AllModelsJaccard.xlsx", index=False)
            dataframeResults.to_excel(f"./results/RResults502.xlsx", index=False)
            dfRes.to_excel(f"./results/{model_parts[1]}1502.xlsx", index=False)
